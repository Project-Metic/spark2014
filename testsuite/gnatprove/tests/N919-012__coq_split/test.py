...
def check_session_file():
    ...
    manual_proof = root.findall(
        (
            "./file/theory[@name='Greatest_common_divisor__g_c_d__subprogram_def']"
            "/goal/transf/goal/transf/goal/proof/"
            "path[@name='Greatest_common_divisor__g_c_d__pragargs__cmp.v']"
        )
    )
...
prove_all(
    prover=["coq"],
    opt=["--limit-line=greatest_common_divisor.ads:10", "--proof=progressive"],
